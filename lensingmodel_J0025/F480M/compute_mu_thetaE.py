...
'''
The position angle and ellipticity are already included in the scripts, in lines starting with "lens sie xxx..."
You need to download glafic from here: https://github.com/oguri/glafic2/tree/main?tab=readme-ov-file
The executable is not included here for copyright reasons.
'''
...
startup 1 0 1
lens sie   1 %d  0 0 0.47 -1.45 0.0 0.0
point 5.07  0 -0.5
end_startup
